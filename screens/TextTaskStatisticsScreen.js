...
const TextTaskStatisticsScreen = () => {
    ...
    async function getDocs() {
        let result = [];
        const docsRef = firestoreDb.collection('TextTask');
    ...
    <View style={styles.container3}>
        <Text style={styles.modalText}>Overall data for text tasks</Text>
        <Modal
            animationType="slide"
            transparent={true}
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.modalText}>Overall statistics for text tasks</Text>
...
export default TextTaskStatisticsScreen
