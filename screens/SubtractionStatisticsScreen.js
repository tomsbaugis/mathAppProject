...
const SubtractionStatisticsScreen = () => {
    ...
    async function getDocs() {
        let result = [];
        const docsRef = firestoreDb.collection('Subtraction');
    ...
    <View style={styles.container3}>
        <Text style={styles.modalText}>Overall data for subtraction tasks</Text>
        <Modal
            animationType="slide"
            transparent={true}
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.modalText}>Overall statistics for subtraction tasks</Text>
...
export default SubtractionStatisticsScreen
