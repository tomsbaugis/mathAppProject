...
const DivisionStatisticsScreen = () => {
    ...
    async function getDocs() {
        let result = [];
        const docsRef = firestoreDb.collection('Division');
    ...
    <View style={styles.container3}>
        <Text style={styles.modalText}>Overall data for division tasks</Text>
        <Modal
            animationType="slide"
            transparent={true}
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.modalText}>Overall statistics for division tasks</Text>
...
export default DivisionStatisticsScreen
