...
const MultiplicationStatisticsScreen = () => {
    ...
    async function getDocs() {
        let result = [];
        const docsRef = firestoreDb.collection('Multiplication');
    ...
    <View style={styles.container3}>
        <Text style={styles.modalText}>Overall data for multiplication tasks</Text>
        <Modal
            animationType="slide"
            transparent={true}
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.modalText}>Overall statistics for multiplication tasks</Text>
...
export default MultiplicationStatisticsScreen
